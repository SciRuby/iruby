...
var IRuby = (function (IRuby) {
    ...
    CodeCell.prototype = new IRuby.Cell();
    ...
    CodeCell.prototype.request_tooltip_after_time = function (pre_cursor,time){
        ...
        if (pre_cursor === "" || pre_cursor === "(" ) {
            ...
            that.tooltip_timeout = setTimeout(function(){
                    IRuby.notebook.request_tool_tip(that, pre_cursor)
                },time);
        }
    };
    ...
    CodeCell.prototype.handle_codemirror_keyevent = function (editor, event) {
        ...
        if (event.keyCode === 13 && (event.shiftKey || event.ctrlKey)) {
            ...
            if (pre_cursor.trim() === "") {
                ...
                IRuby.notebook.complete_cell(this, line, cur.ch);
                return true;
            };
    ...
    CodeCell.prototype.finish_tooltip = function (reply) {
        ...
        morelink.click(function(){
            var msg_id = IRuby.notebook.kernel.execute(name+"?");
            IRuby.notebook.msg_cell_map[msg_id] = IRuby.notebook.get_selected_cell().cell_id;
            that.remove_and_cancel_tooltip();
            setTimeout(function(){that.code_mirror.focus();}, 50);
        });
