...
var IRuby = (function (IRuby) {
    ...
    var TextCell = function (notebook) {
        ...
        IRuby.Cell.apply(this, arguments);
        this.rendered = false;
        this.cell_type = this.cell_type || 'text';
    };


    TextCell.prototype = new IRuby.Cell();
    ...
    TextCell.prototype.bind_events = function () {
        IRuby.Cell.prototype.bind_events.apply(this);
        var that = this;
    ...
    TextCell.prototype.select = function () {
        IRuby.Cell.prototype.select.apply(this);
    ...
    TextCell.prototype.unselect = function() {
        ...
        this.render();
        IRuby.Cell.prototype.unselect.apply(this);
    };
    ...
    var HTMLCell = function (notebook) {
        ...
        IRuby.TextCell.apply(this, arguments);
        this.cell_type = 'html';
    };
    ...
    MarkdownCell.prototype.render = function () {
        if (this.rendered === false) {
            var text = this.get_text();
            if (text === "") { text = this.placeholder; }
            var html = IRuby.markdown_converter.makeHtml(text);
    ...
    HeadingCell.prototype.fromJSON = function (data) {
        ...
        IRuby.TextCell.prototype.fromJSON.apply(this, arguments);
    };


    HeadingCell.prototype.toJSON = function () {
        var data = IRuby.TextCell.prototype.toJSON.apply(this);
    ...
    IRuby.TextCell = TextCell;
    IRuby.HTMLCell = HTMLCell;
    IRuby.MarkdownCell = MarkdownCell;
    IRuby.PlaintextCell = PlaintextCell;
    IRuby.HeadingCell = HeadingCell;
