<b>We are currently developing the kernel compatible with IPython3, the old IPython2-compatible version is in the branch ipython2</b>
...
=== Installation of IPython with virtualenv
